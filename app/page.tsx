    ...
    return (
        <main className="start spotlight-bg">
            ...
            <article className="instructions">
                ...
                <figure className="instructions__fig">
                    <Image
                        ...
                        src={`/PG_guesser.png`}
                        alt="Image of Pokémon guess game"
                        width={1920}
                        height={1080}
                    />
                </figure>
            ...
            <article className="instructions">
                <div className="instructions__desc">
                    <h2>{`Pokédex`}</h2>
                    <p>{`Browse all Pokémon, filter by a generation or search for a specific Pokémon. Click a Pokémon to get some additional information about that Pokémon.`}</p>
